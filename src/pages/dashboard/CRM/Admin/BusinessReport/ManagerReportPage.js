...
import ManagerTableRow from 'sections/@dashboard/CRM/Admin/BusinessReport/list/Manager/ManagerTableRow';
import ManagerTableToolbar from 'sections/@dashboard/CRM/Admin/BusinessReport/list/Manager/ManagerTableToolbar';
...
export default function InvoiceListPage() {
  ...
  return (
    <>
      <Helmet>
        <title> Manager Report: List | Minimal UI</title>
      </Helmet>

      <Container maxWidth={themeStretch ? false : 'lg'}>
        <CustomBreadcrumbs
          heading="Manager Report List"
          links={[
            {
              name: 'Manager',
          ...
          action={
            <Button
              onClick={() => handleDownloadExcel(data, 'manager')}
