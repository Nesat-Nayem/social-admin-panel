...
import VsoTable from '../../VSO/list/VsoTable';
...
function VisitReportEntryNewEditForm() {
  ...
  console.log('id', filteredData, DOCTOR_DATA);
  ...
  const onSubmit = async (data) => {
    try {
      ...
      navigate(PATH_DASHBOARD.manager.end);
      ...
      >
        ...
        >
          <Button
            ...
            onClick={() => navigate(PATH_DASHBOARD.manager.start)}
          >
            {' '}
            Go Back
          </Button>
